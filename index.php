...
Description: Adds web developer details to WordPress frontend page source code. Adds web developer's details to the site's footer. Plugin hides itself after plugin activation. YOU must edit the configs in the plugin index.php file. There are 2 sets of configs to edit. Click the "edit" button before activation.
Version: 1.0.0
Author: Lee Hodson
